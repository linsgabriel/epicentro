<header class="jumbotron" id="topo">
  ...
  <div class="banner">
    ...
    <div class="thumbs">
      <ul>
        <li><a href="#"><img src="assets/img/Jumbotron/jumbotron1.jpg"></a></li>
        <li><a href="#"><img src="assets/img/Jumbotron/jumbotron2.jpg"></a></li>
        <li><a href="#"><img src="assets/img/Jumbotron/jumbotron3.jpg"></a></li>
      </ul>
    </div>
  </div>
